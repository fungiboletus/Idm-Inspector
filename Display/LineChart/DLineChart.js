...
createLegend: function() {
	...
	btn.onclick = function(){
		...
		this.className = obj.multi_scale ? 'btn btn-mini active' : 'btn btn-mini';
	...
	btn.onclick = function(){
		...
		this.className = obj.fill_lines ? 'btn btn-mini active' : 'btn btn-mini';
		EventBus.send('get_tuples');
	};
	buttons_area.appendChild(btn);
	btn = newDom('a', 'btn btn-mini');
	...
	btn.onclick = function(){
		...
		this.className = obj.points ? 'btn btn-mini active' : 'btn btn-mini';
		EventBus.send('get_tuples');
	};
	buttons_area.appendChild(btn);
